 ...
 * Single source of truth for all service categories, subcategories,
 * smart fields, add-ons, and booking templates.
 */
...
const CATEGORIES = {
  cooking: {
    ...
    // Smart fields shown in service creation form for this category
    smartFields: {
      cuisineType: {
    ...
    // Optional add-ons customer can select when booking
    addOns: [
